    ...
    def __init__(self, model: str = "xiaomi/mimo-v2-flash:free"):
        ...
        if os.getenv("OPENROUTER_API_KEY"):
            try:
                ...
                primary_model_name = os.getenv("OPENROUTER_MODEL", "xiaomi/mimo-v2-flash:free")
    ...
    async def translate_with_agent(
        ...
        try:
            ...
            try:
                ...
                model_used = os.getenv("OPENROUTER_MODEL", "xiaomi/mimo-v2-flash:free")
...
# Factory function
def create_translation_agent(model: str = "xiaomi/mimo-v2-flash:free") -> OpenAITranslationAgent:
